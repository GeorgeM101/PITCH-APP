...
def index():
    ...
    return render_template('index.html',title=title,pitch=pitch,upvotes=upvotes,business_pitch=business_pitch,interview_pitch=interview_pitch,sales_pitch=sales_pitch,production_pitch=promotion_pitch)
